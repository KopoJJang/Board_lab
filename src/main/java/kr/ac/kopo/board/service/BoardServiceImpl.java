...
public class BoardServiceImpl implements BoardService{
    ...
    private final BoardRepository repository; //final은 객체 참조값 자동 주입받기 위해
    private final ReplyRepository replyRepository; //final은 객체 참조값 자동 주입받기 위해

    @Override
    public Long register(BoardDTO dto){
        log.info(dto);
//          새 글 등록할 때 전달 받은 dto를 Board 엔티티 객체로 변환하여 반환된
//          Board 객체의 참조값을 사용하여 DB의 Board테이블에 insert
